...
alter table obj_type add foreign key (acl_id) references acl(id);
...
alter table status add foreign key (acl_id) references acl(id);
...
alter table accessor add foreign key (acl_id) references acl(id);
...
alter table org_level add foreign key (accessor_id) references accessor(id);
